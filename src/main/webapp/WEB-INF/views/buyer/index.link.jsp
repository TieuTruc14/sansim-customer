...
<script>
    <c:choose>
    <c:when test="${gprice==null}">
    var gprice=0;
    var gmsisdn=0;
    var gyear=0;
    var gtelco=9;//mac dinh 9 tuc ko tim kiem
    </c:when>
    <c:otherwise>
    var gprice=${gprice};
    var gmsisdn=${gmsisdn};
...
<script src="<%=request.getContextPath()%>/assets/project/customer/index.link.js"></script>
        ...
        <div class="page-content">
            <div class="sim-content clearfix">
                <div class="page-left hide">
                    ...
                    <form>
                        <ul class="list-ul-sim hiden1 ul-price">
                            <li ng-repeat="item in listGroupPrice track by $index">
                                <input type="checkbox" ng-click="searchGroupPrice(item.id)" id="price_{{$index + 1}}" ng-checked="checkPrice" name=""/>
                                <span>{{item.name}}</span>
                    ...
                    <div class="content p-2" id ="list-sim" name ="list-sim">
                        ...
                        <div class="table-responsive hiden1">
                            <div class="form-group text-center" style="margin-top:5px;">
                                <a href="javascript:void(0)" class="bold" style="padding:2px;background-color:#ffffff; color: #474747; !important;border:1px solid #474747;border-radius:4px;" ng-click="unLabelPrice()" ng-show="groupPriceId>0">{{label.price}} <span style="color:#f13131!important">x</span></a>
                                <a href="javascript:void(0)" class="bold" style="padding:2px;background-color:#ffffff; color: #474747; !important;border:1px solid #474747;border-radius:4px;" ng-click="unLabelMsisdn()" ng-show="groupMsisdnId>0">{{label.msisdn}}  <span style="color:#f13131!important">x</span></a>
                                <a href="javascript:void(0)" class="bold" style="padding:2px;background-color:#ffffff; color: #474747; !important;border:1px solid #474747;border-radius:4px;" ng-click="unLabelYear()" ng-show="groupYearId>0">{{label.year}}  <span style="color:#f13131!important">x</span></a>
                                <a href="javascript:void(0)" class="bold" style="padding:2px;background-color:#ffffff; color: #474747; !important;border:1px solid #474747;border-radius:4px;" ng-click="unLabelTelco()" ng-show="groupTelcoId!=9">{{label.telco}}  <span style="color:#f13131!important">x</span></a>
                            </div>
                            <table class="list-sim " >
                                ...
                                <tr ng-repeat="item in page.items track by $index">
                                    ...
                                    <td class="highlight-content">
                                        <a class="btnPopup bold msisdn-text highlight-content"  ng-click="searchDetailMsisdn(item[0])"  href="javascript:void(0)">{{item[8]}}</a>
                                        <a class="btnLink bold msisdn-text highlight-content" href="<%=request.getContextPath()%>/sim/sim-so-dep-{{item[1]}}-{{item[0]}}">{{item[8]}}</a>
                                    </td>
                                    <td >
