    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="bg-primary breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="#">Lịch sử chuyển số cho người bán khác</a></li>
            </ul>
            <section class="panel panel-default">
                <div class="wrapper bg-light lt">
                    ...
                    <form method="post" class="bs-example form-horizontal" data-validate="parsley"
                          action="forwardLog" id="frmSearch">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <label class="col-md-3 control-label"
                                       style="padding-right: 0px; text-align: left;">Người nhận: </label>
                                <div class="col-md-9" style="padding-right: 0px;">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="col-md-3 control-label"
                                       style="padding-right: 0px; text-align: left;">Thời gian chuyển từ ngày: </label>
                                <div class="col-md-9" style="padding-right: 0px;">
                    ...
                    <table id="tbl" class="table table-striped table-bordered m-b-none">
                        <thead>
                            <tr>
                                ...
                                <th class="box-shadow-inner small_col text-left" width="8%" >Người nhận số</th>
                            </tr>
                        </thead>
                            ...
                            <c:if test="${!empty listresult}">
                                <c:forEach var="items" items="${listresult}">
                                    <tr>
                                        ...
                                        <td style="text-align: left;">${items.customerReceiver.username}</td>
                                    </tr>
                                </c:forEach>
                            </c:if>
                        </tbody>
